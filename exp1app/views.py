...
class SamplingList_Update(UpdateView):
    ...
    def get_form(self):
        ...
        form.fields['experiment_situation02'].label='条件02'
        form.fields['experiment_number03'].label='個体数03'
        form.fields['experiment_situation03'].label='条件03'
        form.fields['experiment_number04'].label='個体数04'
        form.fields['experiment_situation04'].label='条件04'
        form.fields['experiment_number05'].label='個体数05'
        form.fields['experiment_situation05'].label='条件05'
        form.fields['experiment_number06'].label='個体数06'
        form.fields['experiment_situation06'].label='条件06'
